...
<!-- main-product -->
  <div class="main-product">
    <!-- left -->
    <div class="left">
      <img src="${base }/user/images/img12.jpg" alt="">
    </div>      
    <!-- /left -->
    <!-- right -->
    <div class="right">
      <h3>Iphone12 Pro Max </h3>
...
<!-- main-product -->
  ...
  <div class="row">
    <div class ="col-12 col-sm-6  col-md-3 bg-primary image">
      ...
      <a href="../frontend/oppo_reno5.html"><img src="${base }/user/images/img6.jpg" alt=""></a>
     </div>
     <a href="../frontend/oppo_reno5.html" class="link"><h3>OPPO Reno5</h3></a>
     <strong class="price">8.690.000₫</strong>
