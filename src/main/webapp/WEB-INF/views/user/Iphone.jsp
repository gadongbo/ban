			...
			<div class="row image-container">
				<div class="col-12 col-sm-6  col-md-3 bg-dark image">
					...
					<div class="content-img">
						<a href="${base }/iphone12"><img
							src="${base }/user/images/img12.jpg" alt=""></a>
					</div>
					<a href="${base }/iphone12" class="link"><h3>Iphone12
							Pro Max</h3></a> <strong class="price">23.690.000₫</strong>
				...
				<div class="col-12 col-sm-6  col-md-3 bg-dark image">
					...
					<a href="../frontend/iphone12.html" class="link"><h3>Iphone12
							Pro Max</h3></a> <strong class="price">23.690.000₫</strong>
					<div class="item-rating">
						<p>
							<i class="icon-star fas fa-star"></i> <i
