			...
			<div class="products">
				<form action="${base }/admin/contact" method="get">
					<a class="btn btn-outline-primary mb-1"
						href="${base }/admin/add-contact" role="button">Add New</a> <input
						...
						<tbody>
							<tr>
								<c:forEach var="contact" items="${contacts }"
									...
									<td><span id="_product_status_${contact.id }"> <c:choose>
									...
									<td><a class="btn btn-primary "
										href=""
										role="button" style="font-size: 13px;"> Edit </a> <a
										role="button" class="btn btn-danger delete-product"
										href="" style="font-size: 13px;">Delete</a></td>
									<tr>
								</c:forEach>
						</tbody>
					</table>
